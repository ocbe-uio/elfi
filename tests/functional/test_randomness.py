...
def test_randomness2(simple_model):
    ...
    samples1 = elfi.Rejection(simple_model['k1'], batch_size=3).sample(n_samples=n, bar=False, max_parallel_batches = 2).samples['k1']
    ...
    samples2 = elfi.Rejection(simple_model['k1'], batch_size=3).sample(n_samples=n, bar=False, max_parallel_batches = 2).samples['k1']
